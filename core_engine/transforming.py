...
def get_sent(text):
    ...
    text = ' '.join([word if word not in stopwords.words('cuts') else word[:-1] for word in text.split()])
...
summarize('C:\\Users\\admin\\Desktop\\test.txt')
# import json
